...
TEST(WorldTest, Creation) {
    World<float> world(1.0f, 2.0f, 3.0f, 0.1f, 10.0f, 4.0f, 90.0f, 100.0f, 10);
    ...
    ASSERT_FLOAT_EQ(0.1f, world.GetBorderWeight());
...
TEST(WorldTest, SetBehaviours) {
    World<float> world(1.0f, 2.0f, 3.0f, 0.1f, 10.0f, 4.0f, 90.0f, 100.0f, 0);
    world.SetAligmentWeight(11.0f);
    world.SetCohesionWeight(12.23f);
    world.SetSeperationWeight(-13.3f);
    world.SetBorderWeight(0.01f);
    ...
    ASSERT_FLOAT_EQ(0.01f, world.GetBorderWeight());
}
...
TEST(WorldTest, MoveBoid0) {
    World<float> world(1.0f, 1.0f, 1.0f, 0.1f, 100.0f, 1.0f, 90.0f, 100.0f, 0);
...
TEST(WorldTest, MoveBoid1) {
    World<float> world(1.0f, 1.0f, 1.0f, 0.1f, 100.0f, 1.0f, 90.0f, 100.0f, 10);
    world.moveBoids();
    ASSERT_EQ(10, world.GetNumberOfBoids());
}
