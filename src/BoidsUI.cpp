...
Frame::Frame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_boidsText = new wxTextCtrl( this, wxID_ANY, wxT("100"), wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER );
	...
	m_speedText = new wxTextCtrl( this, wxID_ANY, wxT("1.0"), wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER );
	...
	m_worldSizeText = new wxTextCtrl( this, wxID_ANY, wxT("100.0"), wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER );
	...
	m_viewDistanceText = new wxTextCtrl( this, wxID_ANY, wxT("10.0"), wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER );
	...
	m_alignmentText = new wxTextCtrl( this, wxID_ANY, wxT("0.5"), wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER );
	...
	m_cohesionText = new wxTextCtrl( this, wxID_ANY, wxT("0.5"), wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER );
	...
	m_separationText = new wxTextCtrl( this, wxID_ANY, wxT("0.5"), wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER );
